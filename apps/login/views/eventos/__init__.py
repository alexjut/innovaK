...
- inscripcion.py   → inscribir_participante, qr_evento
- asistencia.py    → lista_asistencia_pdf
...
"""
from .asistencia import lista_asistencia_pdf
...
from .inscripcion import inscribir_participante, qr_evento
